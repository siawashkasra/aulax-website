...
const tabs = [
  ...
  },
  {
    ...
    subhead: "Explore hidden treasures and unique finds from local businesses in your community. Support local while finding amazing products.",
  ...
  },
  {
    ...
    subhead: "Get rewarded for supporting local businesses. Earn points, unlock exclusive benefits, and enjoy savings on every purchase.",
  ...
  },
  {
    ...
    subhead: "Make eco-friendly choices with digital receipts and sustainability tracking. See the positive impact of supporting local businesses.",
    ctaText: "Learn More",
